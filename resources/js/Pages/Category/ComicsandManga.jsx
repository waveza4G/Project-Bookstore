...
const ComicsandManga = () => {
  ...
  return (
    <div className="container mx-auto p-4 relative">
      <h2 className="text-2xl font-bold mb-4">Comics & Manga แนะนำ</h2>
      ...
      <div className="absolute top-0 right-0 mr-4 mt-2">
        <Link
          href={route('Showcategory.index', { categoryName: 'Comics & Manga' })}
