...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('books', function (Blueprint $table) {
            ...
            $table->foreignId('category_id')->constrained('categories')->onDelete('cascade');  // เชื่อมโยงกับ categories
            $table->foreignId('group_id')->constrained('groups')->onDelete('cascade');  // เชื่อมโยงกับ groups
